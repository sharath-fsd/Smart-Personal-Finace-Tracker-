...
export const ExpenseDashboard = ({ expenses }) => {
  const stats = useMemo(() => {
        ...
        <Card className="bg-gradient-card shadow-finance border-0">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 bg-gradient-primary rounded-full">₹</div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span
                    className={`text-xs font-medium ${stats.monthlyChange >= 0 ? "text-red-500" : "text-green-500"}`}
                  >
